<%@ Page Title="Search Employee" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="employee_search.aspx.vb" Inherits="schoolsys.employee_search" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/employees.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Employees Page ... Search Employee</span>
        </td>
...
<table style="Width:885px; text-align: center; background-color: #99FF66; margin-left: 132px;">
    <tr>
            ...
            <td class="auto-style2"><asp:TextBox ID="txtemp" runat="server" Width="208px"></asp:TextBox></td>
