Public Class sending_books
    ...
    Protected Sub btnsend_Click(sender As Object, e As EventArgs) Handles btnsend.Click
        ...
        End If
        sqlclass.functions.getmethod("insert into sending_metaphor (empname,bookname,date,count) values ('" + cmbemp.Text + "','" + cmbbookname.Text + "','" + txtdate.Text + "','" + txtcount.Text + "')")


        sqlclass.functions.getmethod("update add_book set bookstatus='metaphor' where bookname='" + cmbbookname.Text + "'")
