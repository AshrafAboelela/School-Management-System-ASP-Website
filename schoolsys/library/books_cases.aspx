<%@ Page Title="Books Cases" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="books_cases.aspx.vb" Inherits="schoolsys.books_cases" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/library.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Library Page ... Books Cases</span>
        </td>
...
<table style="Width:450px; text-align: center; background-color: #99FF66; margin-left: 226px;">  
    ...
    <tr>
            <td>Sending Date</td>
            <td><asp:TextBox ID="txtsenddate" runat="server" Width="290px"></asp:TextBox></td>
            <td class="auto-style2"><asp:Label ID="lblsenddate" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
        </tr>
     <tr>
            <td>Rec Date</td>
            <td><asp:TextBox ID="txtrecdate" runat="server" Width="290px"></asp:TextBox></td>
            <td class="auto-style2"><asp:Label ID="lblrecdate" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
        </tr>
     <tr>
            <td>Notes</td>
            <td><asp:TextBox ID="txtnotes" runat="server" Width="290px" Height="42px" TextMode="MultiLine"></asp:TextBox></td>
            <td class="auto-style2"><asp:Label ID="lblnotes" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
        </tr>
        <tr>
           <td></td>
