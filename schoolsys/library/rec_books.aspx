<%@ Page Title="Recieve Books" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="rec_books.aspx.vb" Inherits="schoolsys.rec_books" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/library.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Books Page ... Recieve Books</span>
        </td>
...
<table style="Width:545px; text-align: center; background-color: #99FF66; margin-left: 132px;">
    <tr>
         ...
         <td><asp:Button ID="btnrecieve" runat="server" Text="Recieve Books" Width="113px" style="margin-left: 0px" /></td>
       <td><asp:Label ID="lblbookrecieved" runat="server" Text="Books Recieved" ForeColor="Red" Visible="False"></asp:Label></td>
         </tr>    
        </table>
    </div>
</form>
