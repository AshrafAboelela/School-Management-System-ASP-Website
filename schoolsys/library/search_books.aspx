<%@ Page Title="Search Books" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="search_books.aspx.vb" Inherits="schoolsys.search_books" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/library.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Books Page ... Search Books</span>
        </td>
...
<table style="Width:885px; text-align: center; background-color: #99FF66; margin-left: 132px;">
    <tr>
                   <td class="auto-style6">Choose Book Name :</td>
            <td><asp:DropDownList ID="cmbbook" runat="server" style="margin-left: 0px" Height="16px" Width="204px"></asp:DropDownList></td>
         <td class="auto-style5"><asp:Button ID="btnfind" runat="server" Text="Find" Width="120px" style="margin-left: 0px" /></td>
        <td><asp:Button ID="btnshowall" runat="server" Text="Show All" Width="120px" style="margin-left: 0px" /></td>
        </tr>    
        </table>
    </div>
     <br />
