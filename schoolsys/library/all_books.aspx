<%@ Page Title="All Books" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="all_books.aspx.vb" Inherits="schoolsys.all_books" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/library.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Books Page ... All Books</span>
        </td>
