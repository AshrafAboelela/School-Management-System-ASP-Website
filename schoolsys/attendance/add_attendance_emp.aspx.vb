Public Class add_attendance_emp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sqlclass.functions.getsearch("select COUNT(id) as [total] from add_attendance_emp")
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        sqlclass.functions.getsearch("select id from add_attendance_emp where id='" + txtrowid.Text + "'")
        sqlclass.functions.reader.Read()
        ...
        ' sqlclass.functions.getmethod("insert into add_attendance_emp(id) values('" + txtrowid.Text + "')")
        sqlclass.functions.getmethod("insert into add_attendance_emp (id,empname,mobile,batch,address,status) values('" + txtrowid.Text + "','" + cmbemp.Text + "','" + txtmob.Text + "','" + cmbbatch.Text + "','" + txtadd.Text + "','" + cmbstatus.Text + "')")
        cleartxt()
