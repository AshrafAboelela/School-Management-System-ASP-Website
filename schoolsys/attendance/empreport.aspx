<%@ Page Title="Employee Attendance Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="empreport.aspx.vb" Inherits="schoolsys.empreport" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/attendance.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:green">Attendance Page ... Employee Attendance Report</span>
        </td>
...
<div>
<table style="Width:790px; text-align: center; background-color: #99FF66; margin-left: 132px;">
   <tr>
<td>Choose Employee Name</td>
            <td><asp:DropDownList ID="DropDownList1" runat="server" Width="220px" >
                </asp:DropDownList></td>
         <td><asp:Button ID="btncreate" runat="server" Text="Get Data" Width="80px" /></td>
        </tr>    
    </table>
    </div>
     <br />
