<%@ Page Title="Online Exam" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="online_exam.aspx.vb" Inherits="schoolsys.online_exam" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/examinations.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Examinations Page ... Online Exam</span>
        </td>
...
<table style="Width:450px; text-align: center; background-color: #99FF66; margin-left: 226px;">  
    ...
    <tr>
            <td>Publish</td>
            <td><asp:DropDownList ID="cmbpublish" runat="server" Width="290px" >
                <asp:ListItem>Published</asp:ListItem>
                <asp:ListItem>UnPublished</asp:ListItem>
                </asp:DropDownList></td>
            <td><asp:Label ID="lblpublish" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>            
        </tr>  
         <tr>
           <td></td>
