Public Class create_exam
    ...
    Protected Sub btncreate_Click(sender As Object, e As EventArgs) Handles btncreate.Click
        ...
        sqlclass.functions.getmethod("insert into printingexam (empname,batchs,subject,questioncount,ques1,ques2,ques3,ques4,ques5) values('" + cmbemp.Text + "','" + cmbbatch.Text + "','" + txtsubject.Text + "','" + txtquecount.Text + "','" + txtque1.Text + "','" + txtque2.Text + "','" + txtque3.Text + "','" + txtque4.Text + "','" + txtque5.Text + "')")
