<%@ Page Title="All Students" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="all_students.aspx.vb" Inherits="schoolsys.all_students" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/student.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Students Page ... All Students</span>
        </td>
...
<form runat="server" id="form1" style="position:relative; top: 7px; left: 0px; height: 613px; width: 1018px;">
    ...
    <div>
<table style="Width:100%; margin-left: 150px; text-align: center; background-color: #99FF66; ">
     <tr>
     <td ><asp:Label ID="lbl" runat="server" Text="Show All Students" Font-Size="25px" ForeColor="Red" ></asp:Label></td>
   </tr>    
    </table>
    </div>
     <br />
