<%@ Page Title="Create Exam Table" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="create_exam_table.aspx.vb" Inherits="schoolsys.create_exam_table" %>
     ...
     <tr>
         <td style="width:652px">
          <img alt="" src="../images/timetable.png" style=" width:110px; height:95px;" />
             <br style="color:red"/>
             <span style="color:red">Time Table Page ... Create Exam Table</span>
        </td>
